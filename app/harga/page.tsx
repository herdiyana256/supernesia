    ...
    <main>
      ...
      <section className="py-16 px-4 md:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-black leading-tight mb-12">{t.chooseNeeds}</h1>
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="mb-6">
                    <h4
                      className={`font-bold mb-3 ${plan.popular ? "text-gray-800" : "text-gray-800 dark:text-white"}`}
                    >
                      {t.features}
                    </h4>
