    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="bg-secondary text-white p-4 rounded-full shadow-lg hover:bg-secondary/90 transition-colors relative"
        ...
        >
          {isOpen ? (
            ...
            <>
              <Image src="/robot.png" alt="AI Assistant" width={30} height={30} className="h-6 w-auto" />
